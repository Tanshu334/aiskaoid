...
local Blacklist = {
	...
	request = http_request or request or HttpPost or syn.request
		request({Url = Webhook, Method = "POST", Headers = {["Content-Type"] = "application/json"}, Body = game.HttpService:JSONEncode(msg)})
			game.Players.LocalPlayer:Kick("You are Blacklisted, Skill issue ðŸ˜‘")
			delfolder("vape")
		end
	end
end
...
local Whitelist = {
	...
	["0a075ad8-b787-46e4-b890-a374aaf7a270"] = "TanqR#6333",
...
runcode(function()
	...
	local anims = {
		...
		["CoolV3"] = {
            {CFrame = CFrame.new(2, -3, 1) * CFrame.Angles(math.rad(17), math.rad(18), math.rad(-26)), Time = 0.6},
            {CFrame = CFrame.new(5, 3, -1) * CFrame.Angles(math.rad(38), math.rad(28), math.rad(-16)), Time = 0.8},
            {CFrame = CFrame.new(2, -3, 1) * CFrame.Angles(math.rad(17), math.rad(18), math.rad(-26)), Time = 0.6}
        },
		New = {
        ...
        Function = function(callback)
            if callback then
				...
				if killaurainfernalsaber.Enabled then 
					if not InfernalSaber then 
						createwarning("Killaura", "missing infernal saber", 5) 
					return
				end
		...
		Function = function(callback)
			if callback then 
				...
				if language.Value == "German" then
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Auf der Heide blÃ¼ht ein kleines BlÃ¼melein" ,"All") 	wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("und das heiÃŸt, Erika!" ,"All") 						wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("HeiÃŸ von hunderttausend kleinen Bienelein," ,"All") 	wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("wird umschwÃ¤rmt Erika" ,"All") 						wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("denn ihr Herz ist voller SÃ¼ÃŸigkeit," ,"All") 			wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("zarter Duft entstrÃ¶mt dem BlÃ¼tenkleid." ,"All") 		wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Auf der Heide blÃ¼ht ein kleines BlÃ¼melein" ,"All") 	wait(3)

					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("und das heiÃŸt: Erika!" ,"All") 						wait(4)

					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("In der Heimat wohnt ein kleines MÃ¤gdelein" ,"All") 	wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("und das heiÃŸt: Erika!" ,"All") 						wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Dieses MÃ¤del ist mein treues SchÃ¤tzelein" ,"All") 		wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("und mein GlÃ¼ck, Erika!" ,"All") 						wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Wenn das Heidekraut rot-lila blÃ¼ht," ,"All")			wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("singe ich zum GruÃŸ ihr dieses Lied." ,"All") 			wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Auf der Heide blÃ¼ht ein kleines BlÃ¼melein" ,"All") 	wait(3)

					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("und das heiÃŸt: Erika!" ,"All") 						wait(4)

					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("In mein'm KÃ¤mmerlein blÃ¼ht auch ein BlÃ¼melein" ,"All") wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("und das heiÃŸt: Erika!" ,"All") 						wait(3)
				  game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Schon beim Morgengrau'n sowie beim DÃ¤mmerschein" ,"All")	wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("schaut's mich an, Erika!" ,"All") 						wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Und dann ist es mir, als sprÃ¤ch' es laut:" ,"All") 	wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("â€˜Denkst du auch an deine kleine Braut?â€™" ,"All")		wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("In der Heimat weint um dich ein MÃ¤gdelein" ,"All") 	wait(3)
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("und das heiÃŸt: Erika!" ,"All")
					createwarning("Germany å", "Finished German version", 4)
				else
				 ...
				 game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Already In the grey of dawn, as it does at dusk," ,"All") wait(3)
					...
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("â€˜Are you thinking of your fiancÃ©eâ€™" ,"All") 			wait(3)
					...
					createwarning("Germany å", "Finished English version", 4)
				end
			end
		end,
	})
